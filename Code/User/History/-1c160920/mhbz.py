...
import nltk
from langchain_community.llms.ollama import Ollama  # Assuming tinyllama uses the Ollama wrapper
...
# Step 4: Generate questions using TinyLlama
def generate_questions(qa_pairs):
    # Set up TinyLlama with num_threads=8
    model = Ollama(model="tinyllama", num_threads=8)
    for qa_pair in qa_pairs:
        if qa_pair["question"] == "":
            # Prompt TinyLlama to generate a question
...
def main(pdf_path, output_path):
    ...
    print("Generating questions using TinyLlama...")
